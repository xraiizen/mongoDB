...
var ControlerAliment = /** @class */ (function () {
    ...
    ControlerAliment.getOnAliment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ControlerAliment.getAlimentsByType = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, aliments_1.Aliment.getAlimentsByType(alimentType)];
                    case 1:
                        listeAliments = _a.sent();
                        res.send(listeAliments);
                        return [2 /*return*/];
    ...
    ControlerAliment.patchQuantiteAliment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aliments_1.Aliment.patchQuantiteAliment(req.params.id, req.body)];
                    case 1:
                        _a.sent();
                        res.status(201);
                        res.send();
