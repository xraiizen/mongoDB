...
var ControlerPlat = /** @class */ (function () {
    ...
    ControlerPlat.getOnPlat = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ControlerPlat.getPlatsByType = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, plats_1.Plat.getPlatByType(platType)];
                    case 1:
                        listePlats = _a.sent();
                        res.send(listePlats);
                        return [2 /*return*/];
...
//# sourceMappingURL=controllerPlat.js.map